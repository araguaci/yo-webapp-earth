...
var URL_bg = 'images/earthrainbowbridge.jpg';
var URL_diffuse = 'images/css_globe_diffuse.jpg';
var URL_halo = 'images/css_globe_halo.png';
...
function init(ref) {
    ...
    worldBg.style.backgroundImage = 'url(' + URL_bg + ')';
    ...
    globeHalo.style.backgroundImage = 'url(' + URL_halo + ')';
...
function regenerateGlobe() {
    ...
    var diffuseImgBackgroundStyle = 'url(' + URL_diffuse + ')';
...
function rotate(vertex, x, y, z) {
    ...
    var z0 = z0 * cosRX + y * sinRX;

    var offset = 1 + (z0 / 4000);
    var x1 = x0 * cosRZ - y0 * sinRZ;
    var y0 = y0 * cosRZ + x0 * sinRZ;
